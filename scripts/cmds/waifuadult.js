...
module.exports = {
        ...
        onStart: async function ({ api, message, args, event, getLang }) {
                ...
                try {                
                        ...
                        const response = await axios.get(`${await baseApiUrl()}/api/waifuadult?type=${type}`);
