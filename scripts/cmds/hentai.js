...
module.exports = {
        ...
        onStart: async function ({ api, event, message, getLang }) {
                ...
                const filePath = path.join(__dirname, "cache", `hentai_${Date.now()}.mp4`);
                ...
                try {
                        ...
                        const res = await axios.get(`${apiUrl}/api/segs/mahmud/videos/hentai?userID=${event.senderID}`);
